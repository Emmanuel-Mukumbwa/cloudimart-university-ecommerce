...
export default function Header() {
  ...
  // Fetch orders & notifications count periodically
  useEffect(() => {
    let mounted = true;
  ...
  const handleLogout = async () => {
    try {
      ...
      // ignore server errors but still clear local data
    } finally {
      try {
      ...
      >
        <div className="container d-flex align-items-center justify-content-between py-3">
          ...
          <nav className="d-flex align-items-center gap-3">
            ...
            {!user ? (
              <>
                <Link href="/login" className="text-white text-decoration-none small">
                  Login
                </Link>
                <Link href="/register" className="text-white text-decoration-none small">
                  Register
                </Link>
              </>
            ) : (
